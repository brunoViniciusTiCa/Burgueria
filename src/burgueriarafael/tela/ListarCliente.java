...
public class ListarCliente extends javax.swing.JFrame {
    ...
    private ClienteFachada clienteFachada = null;
    ...
    private void preencherTabelaCliente(){
        ...
        try {
            ...
            listaCliente = clienteFachada.consultarCliente();
            if (jTable1.getRowCount()>0) {
                Uteis.AlertInfo(this, "Todos Clientes foram listados com sucesso.");
            }
    ...
    private void initComponents() {
        ...
        lbl_tela.setText("Clientes KoF Burguers");
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            ...
            clienteSelecionado = listaCliente.get(posicaoSelecionada);
            
            CadastrarCliente telaCadastrarCliente = new CadastrarCliente(CadastrarCliente.TELA_MODO_EDITAR , clienteSelecionado);
        ...
        if (posicaoSelecionada > -1) {
            try {
                ...
                if (resutBtnClick == JOptionPane.YES_OPTION) {
                    clienteFachada.deletarCliente(clienteSelecionado);
                    Uteis.AlertInfo(this, "Cliente deletado com sucesso.");
                    preencherTabelaCliente();
                }
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        CadastrarCliente telaCadastrarCliente = new CadastrarCliente(CadastrarCliente.TELA_MODO_CADASTRAR, null);
        telaCadastrarCliente.setVisible(true);
        abrindoTela = true;
        dispose();
