...
public class ListarFuncionario extends javax.swing.JFrame {
    ...
    private FuncionarioFachada funcionarioFachada = null;
    ...
    private void preencherTabelaFuncionario(){
        ...
        try {
            ...
            listaFuncionario = funcionarioFachada.consultarFuncionario();
            if (jTable1.getRowCount()>0) {
                Uteis.AlertInfo(this, "Todos funcionarios foram listados com sucesso.");
            }
        ...
        for (Funcionario funcionario : listaFuncionario) {
            ...
            Object object [] = new Object[]{
                ...
                funcionario.getSexoFuncionario()
    ...
    private void initComponents() {
        ...
        lbl_tela.setText("Funcionarios KoF Burguers");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdFuncionario", "CpfFuncionario", "fone Funcionario", "End Funcionario", "Nome Funcionario", "Sexo Funcionario"
            }
        ) {
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            ...
            funcionarioSelecionado = listaFuncionario.get(posicaoSelecionada);
            
            CadastrarFuncionario telaCadastrarFuncionario = new CadastrarFuncionario(CadastrarFuncionario.TELA_MODO_EDITAR , funcionarioSelecionado);
    ...
    private void btn_deletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deletarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            try {
                Funcionario livroSelecionado ;
                livroSelecionado = listaFuncionario.get(posicaoSelecionada);

                int resutBtnClick = Uteis.ConfirmeDialog(this, "Deseja realmente deletar esse funcionario?");

                if (resutBtnClick == JOptionPane.YES_OPTION) {
                    funcionarioFachada.deletarFuncionario(livroSelecionado);
                    Uteis.AlertInfo(this, "Funcionario deletado com sucesso.");
                    preencherTabelaFuncionario();
                }
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        CadastrarFuncionario telaCadastrarFuncionario = new CadastrarFuncionario(CadastrarFuncionario.TELA_MODO_CADASTRAR, null);
        telaCadastrarFuncionario.setVisible(true);
        abrindoTela = true;
        dispose();
