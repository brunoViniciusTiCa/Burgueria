...
public class ListarPedido extends javax.swing.JFrame {
    ...
    private PedidoFachada pedidoFachada = null;
    ...
    private void preencherTabelaCliente(){
        ...
        try {
            ...
            listaPedido = pedidoFachada.select();
            if (jTable1.getRowCount()>0) {
                Uteis.AlertInfo(this, "Todos Pedidos foram listados com sucesso.");
            }
        ...
        for (Pedido pedido : listaPedido) {
            ...
            Object object [] = new Object[]{
                ...
                pedido.getProduto().getValorProduto(),
                pedido.getQtdProduto(),
    ...
    private void initComponents() {
        ...
        lbl_tela.setText("Pedidos KoF Burguers");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdPedido", "Status Pedido", "Valor Produto", "Nome Produto", "Qtd Produto", "Id Produto"
            }
        ) {
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            ...
            pedidoSelecionado = listaPedido.get(posicaoSelecionada);
            
            CadastrarPedido telaCadastrarPedido = new CadastrarPedido(CadastrarPedido.TELA_MODO_EDITAR , pedidoSelecionado);
    ...
    private void btn_deletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deletarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            try {
                ...
                int resutBtnClick = Uteis.ConfirmeDialog(this, "Deseja realmente deletar esse Pedido?");

                if (resutBtnClick == JOptionPane.YES_OPTION) {
                    pedidoFachada.deletarPedido(pedidoSelecionado);
                    Uteis.AlertInfo(this, "Pedido deletado com sucesso.");
                    preencherTabelaCliente();
                }
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        CadastrarPedido telaCadastrarPedido = new CadastrarPedido(CadastrarPedido.TELA_MODO_CADASTRAR, null);
        telaCadastrarPedido.setVisible(true);
        abrindoTela = true;
        dispose();
